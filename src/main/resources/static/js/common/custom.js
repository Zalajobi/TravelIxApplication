...
function childrenAge() {
	...
	if (children < 1) {
		...
		document.getElementById("childrenAges").style.display = "flex";
		document.getElementById("child-1").style.display = "flex";
		...
		document.getElementById("childrenAges").style.display = "flex";
		document.getElementById("child-1").style.display = "flex";
		document.getElementById("child-2").style.display = "flex";
		document.getElementById("child-3").style.display = "none";
		document.getElementById("child-4").style.display = "none";
	} if (children == 3) {
		document.getElementById("childrenAges").style.display = "flex";
		document.getElementById("child-1").style.display = "flex";
		document.getElementById("child-2").style.display = "flex";
		document.getElementById("child-3").style.display = "flex";
		document.getElementById("child-4").style.display = "none";
	} if (children ==4) {
		document.getElementById("childrenAges").style.display = "flex";
		document.getElementById("child-1").style.display = "flex";
		document.getElementById("child-2").style.display = "flex";
		document.getElementById("child-3").style.display = "flex";
		document.getElementById("child-4").style.display = "flex";
	}
};


function resultpopup() {
	var imageUrl = 'https://tenor.com/view/load-loading-gif-5662595'
	alert('https://tenor.com/view/load-loading-gif-5662595')
}